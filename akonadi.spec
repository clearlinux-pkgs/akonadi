...
Version  : 19.12.2
Release  : 32
URL      : https://download.kde.org/stable/release-service/19.12.2/src/akonadi-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/akonadi-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/akonadi-19.12.2.tar.xz.sig
...
%prep
%setup -q -n akonadi-19.12.2
cd %{_builddir}/akonadi-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581046492
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/akonadi/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/akonadi-19.12.2/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/akonadi/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/akonadi-19.12.2/src/3rdparty/Optional/LICENSE %{buildroot}/usr/share/package-licenses/akonadi/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/akonadi-19.12.2/src/3rdparty/Optional/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/akonadi/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/akonadi-19.12.2/src/3rdparty/Optional/copyright.txt %{buildroot}/usr/share/package-licenses/akonadi/a42074d90029e7ea8aa50377e7bc07e63278d9c1
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiAgentBase.so.5.13.2
/usr/lib64/libKF5AkonadiCore.so.5
/usr/lib64/libKF5AkonadiCore.so.5.13.2
/usr/lib64/libKF5AkonadiPrivate.so.5
/usr/lib64/libKF5AkonadiPrivate.so.5.13.2
/usr/lib64/libKF5AkonadiWidgets.so.5
/usr/lib64/libKF5AkonadiWidgets.so.5.13.2
/usr/lib64/libKF5AkonadiXml.so.5
/usr/lib64/libKF5AkonadiXml.so.5.13.2
