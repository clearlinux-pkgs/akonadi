...
Version  : 19.04.2
Release  : 16
URL      : https://download.kde.org/stable/applications/19.04.2/src/akonadi-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/akonadi-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/akonadi-19.04.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1559875239
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5AkonadiAgentBase.so.5.11.2
/usr/lib64/libKF5AkonadiCore.so.5
/usr/lib64/libKF5AkonadiCore.so.5.11.2
/usr/lib64/libKF5AkonadiPrivate.so.5
/usr/lib64/libKF5AkonadiPrivate.so.5.11.2
/usr/lib64/libKF5AkonadiWidgets.so.5
/usr/lib64/libKF5AkonadiWidgets.so.5.11.2
/usr/lib64/libKF5AkonadiXml.so.5
/usr/lib64/libKF5AkonadiXml.so.5.11.2
