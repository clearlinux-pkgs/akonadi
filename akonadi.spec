...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/akonadi-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/akonadi-22.12.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-22.12.1
cd %{_builddir}/akonadi-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673287293
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiAgentBase.so.5.22.1
/usr/lib64/libKF5AkonadiCore.so.5
/usr/lib64/libKF5AkonadiCore.so.5.22.1
/usr/lib64/libKF5AkonadiPrivate.so.5
/usr/lib64/libKF5AkonadiPrivate.so.5.22.1
/usr/lib64/libKF5AkonadiWidgets.so.5
/usr/lib64/libKF5AkonadiWidgets.so.5.22.1
/usr/lib64/libKF5AkonadiXml.so.5
/usr/lib64/libKF5AkonadiXml.so.5.22.1
