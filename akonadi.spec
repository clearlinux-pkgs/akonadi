...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/akonadi-22.08.0.tar.xz
...
%prep
%setup -q -n akonadi-22.08.0
cd %{_builddir}/akonadi-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661538253
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiAgentBase.so.5.21.0
/usr/lib64/libKF5AkonadiCore.so.5
/usr/lib64/libKF5AkonadiCore.so.5.21.0
/usr/lib64/libKF5AkonadiPrivate.so.5
/usr/lib64/libKF5AkonadiPrivate.so.5.21.0
/usr/lib64/libKF5AkonadiWidgets.so.5
/usr/lib64/libKF5AkonadiWidgets.so.5.21.0
/usr/lib64/libKF5AkonadiXml.so.5
/usr/lib64/libKF5AkonadiXml.so.5.21.0
